...
then
    ...
    echo ""
    echo "Copy tv_known_hosts $HOST:.ssh/known_hosts"
    scp $TEMPLATE_DIR/tv_known_hosts $HOST:.ssh/known_hosts
    echo ""
    echo "Copy id_rsa_pvr $HOST:.ssh/id_rsa_pvr"
    scp /home/tuxa/.ssh/id_rsa_pvr $HOST:.ssh/id_rsa
    echo ""
    echo "Change ssh permission"
